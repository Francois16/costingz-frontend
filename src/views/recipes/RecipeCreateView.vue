...
<template>
  ...
  <h3 class="text-2xl mb-5 border-b max-w-xl pb-5">Recipe Details</h3>
  ...
  <form @submit.prevent="createRecipe" class="max-w-xl flex flex-col gap-2">
    ...
    <div class="mt-5">
      <label class="text-2xl block mb-5 border-b pb-5">
        Recipe Ingredients
      </label>
      <span
      ...
      >
        No ingredients added yet, try searching for one below and add it to the
        recipe
      </span>
