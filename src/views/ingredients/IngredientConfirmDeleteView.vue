  ...
  <div class="flex flex-col gap-4">
    <div v-if="recipes.length">
      <div class="bg-red-200 p-6">
        <span class="block font-bold text-3xl text-red-600 mb-4">Warning!</span>
        <div class="flex flex-col gap-4">
          <p>
            The ingredient
            <span class="font-bold">{{ ingredient.name }}</span> is used in the
            following recipes. If you delete this ingredient, we will also
            remove it from the recipes below.
          </p>
          <p>
